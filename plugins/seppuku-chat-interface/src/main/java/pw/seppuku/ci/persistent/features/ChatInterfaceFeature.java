...
public final class ChatInterfaceFeature extends PersistentFeature {
    ...
    private static final UUID CHAT_INTERFACE_UNIQUE_IDENTIFIER = UUID.fromString("0fb128d8-5203-4665-9adb-f35f052896dc");
    private static final String CHAT_INTERFACE_HUMAN_IDENTIFIER = "chat-interface";
    private static final Version CHAT_INTERFACE_VERSION = new Version(0, 1, 0, Optional.empty(), Optional.empty());
