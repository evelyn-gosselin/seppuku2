...
public final class PluginsFeature extends ExecutableFeature {
  ...
  private static final UUID PLUGINS_UNIQUE_IDENTIFIER = UUID.fromString(
      "ecc7bf3e-7195-44ac-84da-b1f1f2320856");
  private static final String PLUGINS_HUMAN_IDENTIFIER = "plugins";
  private static final Version PLUGINS_VERSION = new Version(0, 1, 0, Optional.empty(),
      Optional.empty());
  private static final List<Author> PLUGINS_AUTHORS = List.of(
